...
public class CottonCandyMachineBlock extends BlockWithEntity {
    ...
    public static final int TOTAL_TIME = START_SPIN_TIME + 3 * TIME_FOR_ONE_LAYER;
    ...
    protected ItemActionResult onUseWithItem(ItemStack stack, BlockState state, World world, BlockPos pos,
        ...
        if (!(stack.isEmpty() || item instanceof ModifiedStickItem) &&
            world.getBlockEntity(pos) instanceof CottonCandyMachineBlockEntity machine) {
            int amount = 0;
